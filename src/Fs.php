    ...
    public function lst($id, $with_root = false) {
        ...
        foreach($lst as $item) {
            ...
            if(is_dir($dir . DIRECTORY_SEPARATOR . $item)) {
                $res[] = array('text' => $item, 'children' => true,  'id' => $this->id($dir . DIRECTORY_SEPARATOR . $item), 'icon' => 'fa fa-folder-o');
            }else {
                $res[] = array('text' => $item, 'children' => false, 'id' => $this->id($dir . DIRECTORY_SEPARATOR . $item), 'type' => 'file', 'icon' => 'fa fa-file-text-o');
            }
        }
